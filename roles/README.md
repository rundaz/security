...
[![GoDoc](https://godoc.org/github.com/rundaz/security/roles?status.svg)](https://godoc.org/github.com/rundaz/security/roles)

## Usage

### Permission Modes

Permission modes are really the *roles* in [Roles](https://github.com/rundaz/security/roles). [Roles](https://github.com/rundaz/security/roles) has [5 default permission modes](https://github.com/rundaz/security/roles/blob/master/permission.go#L8-L12):
...
Please note that, when using [Roles](https://github.com/rundaz/security/roles) with [L10n](http://github.com/qor/l10n). The
...
```go
import "github.com/rundaz/security/roles"
...
When checking permissions, you will need to know current user's *roles* first. This could quickly get out of hand if you have defined many *roles* based on lots of conditions - so [Roles](https://github.com/rundaz/security/roles) provides some helper methods to make it easier:
