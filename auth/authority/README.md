...
It is based on [Roles](http://github.com/rundaz/security/roles), means to define an ability, you need to register a role with `Roles`, refer [Roles](http://github.com/rundaz/security/roles) for how to do that.

## Usage

### Initialize Authority

Authority could use with [Auth](http://github.com/rundaz/security/auth) to get current user, handle sessions, you could use it, or implement your own [AuthInterface](http://godoc.org/github.com/rundaz/security/auth/authority#AuthInterface)

```go
import (
  "github.com/rundaz/security/auth"
  "github.com/rundaz/security/auth/authority"
  "github.com/rundaz/security/roles"
)
...
Refer [Roles](http://github.com/rundaz/security/roles) for how to use roles to register roles, here is a sample:
...
Authority provides some [Rules](http://godoc.org/github.com/rundaz/security/auth/authority#Rule) to make you define them easily, used like:
